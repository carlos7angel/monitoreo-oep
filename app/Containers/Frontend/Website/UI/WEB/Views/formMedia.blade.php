            ...
            <div class="card" style="filter: drop-shadow(0px 0px 40px rgba(68, 81, 96, 0.08))">
                <div class="card-body p-lg-20">
                    <div class="text-center mb-5 mb-lg-10">
                        <h3 class="fs-2hx text-gray-900 mb-5" id="portfolio" data-kt-scroll-offset="{default: 100, lg: 250}">Registro de Nuevos Medios</h3>
                    </div>
                    ...
                    <div class="mx-auto w-100 mw-600px pt-10 pb-10" id="form_media_content">
                        ...
                        <form class="" novalidate="novalidate" autocomplete="off"
                            ...
                            <div class="notice d-flex bg-light-info rounded border-info border border-dashed mb-9 p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        <h4 class="text-gray-900 fw-bold">Nuevo Registro</h4>
                                        <div class="fs-6 text-gray-700">
                                            Ingresa los datos para el registro de medios, una vez ingresado los datos se le enviará un correo de conformación.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">¿Ya tienes una cuenta?
                                <a href="#" class="link-primary fw-semibold">Ingresar</a>
                            </div>
...
@section('scripts')
    <script src="{{ asset('themes/external/js/landing/media-registration.js') }}"></script>
@endsection