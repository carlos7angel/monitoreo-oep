                    ...
                    <div class="card-body pt-5">
                        <div class="d-flex flex-column gap-5">
                            <div class="d-flex flex-stack">
                                <a href="{{ route('ext_admin_media_profile_general_data_show') }}" class="fs-6 fw-bold text-gray-800 text-hover-primary text-active-primary active">Datos Generales</a>
...
{{--                            </div>--}}
            ...
            <div class="col-xl-9">
                <div class="card card-flush h-lg-100" style="border: none !important; box-shadow: unset !important;">
                    ...
                    <div class="card-body pt-5">
                        <!--begin::Form-->
                        <form id="kt_media_profile_general_data_form" class="form" action="{{ route('ext_admin_media_profile_general_data_store') }}" method="post" autocomplete="off">

                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold form-label mt-3">
                                    <span class="required">Nombre del medio</span>
                                </label>
                                <input type="text" class="form-control" name="media_name" value="{{ $profile->name }}" />
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control" name="media_business_name" value="{{ $profile->business_name }}" />
                            </div>
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control" name="media_nit" value="{{ $profile->nit }}" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control" name="media_rep_full_name" value="{{ $profile->rep_full_name }}" />
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control" name="media_rep_document" value="{{ $profile->rep_document }}" />
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Selecciona un departamento"
                                                ...
                                                <option></option>
                                                <option value="La Paz" {{ $profile->rep_exp == 'La Paz' ? 'selected="selected"' : '' }}>La Paz</option>
                                                <option value="Cochabamba" {{ $profile->rep_exp == 'Cochabamba' ? 'selected="selected"' : '' }}>Cochabamba</option>
                                                <option value="Santa Cruz" {{ $profile->rep_exp == 'Santa Cruz' ? 'selected="selected"' : '' }}>Santa Cruz</option>
                                                <option value="Chuquisaca" {{ $profile->rep_exp == 'Chuquisaca' ? 'selected="selected"' : '' }}>Chuquisaca</option>
                                                <option value="Tarija" {{ $profile->rep_exp == 'Tarija' ? 'selected="selected"' : '' }}>Tarija</option>
                                                <option value="Oruro" {{ $profile->rep_exp == 'Oruro' ? 'selected="selected"' : '' }}>Oruro</option>
                                                <option value="Potosí" {{ $profile->rep_exp == 'Potosí' ? 'selected="selected"' : '' }}>Potosí</option>
                                                <option value="Beni" {{ $profile->rep_exp == 'Beni' ? 'selected="selected"' : '' }}>Beni</option>
                                                <option value="Pando" {{ $profile->rep_exp == 'Pando' ? 'selected="selected"' : '' }}>Pando</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control" name="media_description">{!! $profile->description !!}</textarea>
                            </div>
...
@section('scripts')
    <script src="{{ asset('themes/external/js/custom/media-profile/general.js') }}"></script>
@endsection