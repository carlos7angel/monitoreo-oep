                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-5">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="d-flex flex-stack">
                                <a href="{{ route('ext_admin_media_profile_contact_data_show') }}" class="fs-6 fw-bold text-gray-800 text-hover-primary text-active-primary active">Datos de Contacto</a>
                                <i class="ki-outline ki-arrow-right"></i>
                            </div>
                            <div class="d-flex flex-stack">
...
{{--                            </div>--}}
            ...
            <div class="col-xl-9">
                ...
                <div class="card card-flush h-lg-100" style="border: none !important; box-shadow: unset !important;">
                    ...
                    <div class="card-body pt-5">
                        <!--begin::Form-->
                        <form id="kt_media_profile_contact_data_form" class="form" action="{{ route('ext_admin_media_profile_contact_data_store') }}" method="post" autocomplete="off">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control" name="media_email" value="{{ $profile->email }}" readonly disabled />
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control" name="media_legal_address" value="{{ $profile->legal_address }}" />
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control" name="media_contact_full_name" value="{{ $profile->contact_full_name }}" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control" name="media_cellphone" value="{{ $profile->cellphone }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control" name="media_website" value="{{ $profile->website }}" />
                                <div class="text-muted fs-7 mt-1">Página web oficial del medio, con dominio propio.</div>
                            </div>

                            <div class="fv-row mb-7">
{{--                                <label class="fs-6 fw-semibold form-label mt-3">--}}
{{--                                    <span class="required">Redes Sociales</span>--}}
{{--                                </label>--}}
                                <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                    ...
                                    <div id="kt_media_profile_add_rrss_options">
                                        ...
                                        @endphp
                                        @if($profile->rrss)
                                            <input type="hidden" name="media_rrss" value="{{ json_encode($rrss) }}">
                                        @endif
...
@section('scripts')
    ...
    <script src="{{ asset('themes/external/js/custom/media-profile/contact.js') }}"></script>
@endsection