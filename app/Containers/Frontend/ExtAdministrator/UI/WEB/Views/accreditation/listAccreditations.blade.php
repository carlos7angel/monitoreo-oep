...
@section('content')
    <div id="kt_app_content" class="app-content">
        ...
        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_accreditations"
                       data-url="{{ route('ext_admin_accreditations_list_json_dt') }}" aria-describedby="table"> <!-- //NOSONAR -->
                    <thead>
