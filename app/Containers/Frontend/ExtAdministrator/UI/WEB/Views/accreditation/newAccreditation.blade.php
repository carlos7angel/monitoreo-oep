...
@section('content')
    <div id="kt_app_content" class="app-content">
        ...
        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10" id="kt_create_accreditation_stepper">
                ...
                <div class="card border border-dashed border-gray-300 mb-7">
                    <div class="card-body">
                        ...
                        <div class="mb-0">
                            ...
                            <div class="fw-bold text-gray-800 fs-6 kt_data_accreditation_submitted_at">{{ \Carbon\Carbon::today()->format('d/m/Y') }}</div>
                        </div>
                    </div>
                </div>
            ...
            <!--begin::Content-->
            <form class="w-100" action="{{ route('ext_admin_accreditations_store') }}" novalidate="novalidate" id="kt_election_accreditation_form" method="post">
                <!--begin::Step 1-->
                                ...
                                <div class="flex-lg-row-fluid me-xl-18__xx mb-10 mb-xl-0">
                                    <div class="mt-n1">
                                        ...
                                        <div class=" flex-column pb-5">
                                            <a href="javascript:void(0)" id="kt_button_select_election_new" class="btn btn-sm btn-secondary mb-5" data-url="{{ route('ext_admin_election_accreditations_active_elections_list_partial') }}">Seleccionar Proceso</a>
                                            {{--<img alt="Logo Proceso Electoral" src="" class="h-100px kt_data_election_logo d-none" />--}}
                                        </div>
                                        <div class="fv-row"><input type="hidden" name="media_election"></div>
                                        <div class="m-0">
                                            {{--<div class="fw-bold fs-3 text-gray-800 mb-8 kt_data_election_name"></div>--}}
                            ...
                            <div class="d-flex flex-column gap-7 gap-md-10">
                                ...
                                <div class="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                    ...
                                    <div class="flex-root d-flex flex-column">
                                        ...
                                        <span class="fs-5">{{ $profile->business_name }}</span>
                                    </div>
                                    <div class="flex-root d-flex flex-column">
                                        <span class="text-muted">NIT</span>
                                        <span class="fs-5">{{ $profile->nit }}</span>
                                    </div>
                                </div>
                                ...
                                @if($item_type_print)
                                    ...
                                    @foreach($states as $state)
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="file" name="media_print_file_rate[{{$state}}]" class="files kt_media_file_rates" data-maxsize="5" data-maxfiles="1" data-accept="pdf">
                                            <div class="text-muted fs-7">Máximo de tamaño permitido 5MB. Formatos aceptados: PDF</div>
                                        </div>
                                    @endforeach
                                @endif
                                ...
                                @if($item_type_digital)
                                    ...
                                    @foreach($states as $state)
                                        <div class="fv-row mb-10">
                                            ...
                                            <input type="file" name="media_digital_file_rate[{{$state}}]" class="files kt_media_file_rates" data-maxsize="5" data-maxfiles="1" data-accept="pdf">
                                            <div class="text-muted fs-7">Máximo de tamaño permitido 5MB. Formatos aceptados: PDF</div>
                                        </div>
                                    @endforeach
                                @endif
...
@section('scripts')
    ...
    <script src="{{ asset('themes/external/js/custom/accreditation/new-accreditation.js') }}"></script>
@endsection