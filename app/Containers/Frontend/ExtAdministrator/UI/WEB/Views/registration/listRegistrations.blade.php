...
@section('breadcrumbs')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">Procesos Electorales</li>
    </ul>
@endsection
        ...
        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_registrations"
                       data-url="{{ route('ext_admin_registration_elections_list_json_dt') }}" aria-describedby="table"><!-- //NOSONAR -->
                    <thead>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/external/js/custom/registration/list.js') }}"></script>
@endsection