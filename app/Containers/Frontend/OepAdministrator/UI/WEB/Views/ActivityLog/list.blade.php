@extends('vendor@template::admin.layouts.master', ['page' => 'log_list'])
    ...
    <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="row g-8 mb-5">
                        <div class="col-xxl-5">
                            ...
                            <select class="form-select form-select-solid datatable-input" data-col-index="1" name="kt_search_type" >
                                ...
                                <option value="{{ $type->log_name }}">{{$type->log_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-xxl-7">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_logs" data-url="{{ route('oep_admin_activity_logs_json_dt') }}">
                    <thead>
