...
<div class="d-flex align-items-center bg-light rounded px-5 py-4 mb-6 shadow shadow-xs">
    <i class="fa {{ $field->fieldType->icon }} text-info fs-1 me-5"></i>
...
{{--<div class="d-flex align-items-center bg-light rounded px-5 py-4 mb-6 shadow shadow-xs">--}}
{{--    <i class="fa fa-eye text-info fs-1 me-5"></i>--}}
{{--    <div class="flex-grow-1 me-2">--}}
{{--        <a href="#" class="fw-bold text-gray-800 text-hover-primary fs-6">Nombre Completo</a>--}}
{{--        <span class="text-muted fw-semibold d-block">Campo de texto</span>--}}
{{--    </div>--}}
{{--    <div>--}}
{{--        <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-secondary">--}}
{{--            <i class="ki-outline ki-pencil fs-4"></i>--}}
{{--        </button>--}}
{{--        <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-secondary">--}}
{{--            <i class="ki-outline ki-trash fs-4"></i>--}}
