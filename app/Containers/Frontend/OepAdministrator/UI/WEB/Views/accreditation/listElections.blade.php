...
@section('content')
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_elections_accreditation"
                       data-url="{{ route('oep_admin_media_elections_list_for_accreditation_json_dt') }}" aria-describedby="table"><!-- //NOSONAR -->
                    <thead>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/accreditations/list_elections.js') }}"></script>
@endsection