...
@section('breadcrumbs')
    ...
    <div class="d-flex align-items-center">
        <a href="{{ route('oep_admin_elections_create') }}" class="btn btn-primary px-5" id="kt_button_new_form"><i class="ki-outline ki-add-files me-2 fs-3"></i> Nuevo Proceso</a>
    </div>
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/elections/list.js') }}"></script>
@endsection