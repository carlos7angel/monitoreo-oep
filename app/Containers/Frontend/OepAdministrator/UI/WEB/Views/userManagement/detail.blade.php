                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            <div class="symbol symbol-100px symbol-circle mb-7">
                                <img src="{{ asset('themes/common/media/images/blank-user.jpg') }}" alt="" />
                            </div>
                            ...
                            <div class="d-flex flex-wrap flex-center">
                                <div class="border border-gray-300 border-dashed rounded py-3 px-3 mb-3">
                                    <div class="fs-4 fw-bold text-gray-700">
                                        <span class="w-75px fs-7">{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $user->created_at)->format('d/m/Y H:i') }}</span>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->email }}</td>
                                    <td class="text-end">
{{--                                        <button type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px ms-auto" id="#kt_modal_update_email">--}}
...
{{--                                        </button>--}}
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
{{--                                        <button type="button" class="btn btn-icon btn-active-light-primary w-30px h-30px ms-auto" id="#kt_modal_update_role">--}}
{{--                                            <i class="ki-duotone ki-pencil fs-3">--}}
{{--                                                <span class="path1"></span>--}}
{{--                                                <span class="path2"></span>--}}
{{--                                            </i>--}}
