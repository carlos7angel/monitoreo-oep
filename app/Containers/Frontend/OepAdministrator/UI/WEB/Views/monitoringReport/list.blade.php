    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_monitoring_reports"
                       data-url="{{ route('oep_admin_monitoring_report_list_json_dt') }}" aria-describedby="table"> <!-- //NOSONAR -->
                    <thead>
...
@section('scripts')
    ...
    <script src="{{ asset('themes/admin/js/custom/monitoring_report/list.js') }}"></script>
@endsection