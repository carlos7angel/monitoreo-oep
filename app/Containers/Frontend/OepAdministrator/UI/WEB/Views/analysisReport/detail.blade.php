                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-aligns-center mb-5">
                                    ...
                                    <div class="ms-1 fw-semibold">
                                        <a href="{{ route('oep_admin_media_monitoring_generate_pdf', ['id' => $analysis_report->monitoringReport->monitoringItem->id]) }}" target="_blank" class="fs-6 text-hover-primary__ fw-bold">Descargar</a>
                                    </div>
                                </div>
