                        ...
                        <div class="d-flex flex-wrap justify-content-start">
                            <div class="d-flex flex-wrap">
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="fs-4 fw-bold"><?php echo e($election->end_date_media_registration); ?></div>
                                    </div>
        ...
        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_accreditations_by_election"
                       data-url="<?php echo e(route('oep_admin_media_accreditations_by_election_json_dt', ['id' => $election->id])); ?>">
                    <thead>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/admin/js/custom/accreditations/accreditations_by_elections.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', ['page' => 'media_accreditations'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\OepAdministrator/UI/WEB/Views//accreditation/listByElection.blade.php ENDPATH**/ ?>