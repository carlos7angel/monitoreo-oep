...
<head>
    <style>
        ...
        /*----Tabla contenidos de los campos----*/
...
<header>
    ...
    <table border="0" style="width: 100%; border-collapse: collapse; border: 0; background-color:#88407d;">
        <tr>
            ...
            <td style="width: 60%; text-align: center; vertical-align: middle; font-size: 20px; font-weight: bold; text-transform: uppercase;">
                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                    ...
                    <div style="color:#FFD7CB;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:150%;padding-top:0px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                        <div style="font-size: 12px; line-height: 18px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #FFD7CB;">
                            <p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"><?php echo e($election->name); ?></p>
                        </div>
                    </div>
                </div>
            </td>
            <td style="width: 20%; text-align: right; vertical-align: middle;">
                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                    ...
                    <div style="color:#FFFFFF;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                        <div style="line-height: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; color: #FFFFFF;">
                            <p style="line-height: 21px; text-align: center; font-size: 12px; margin: 0;"><span style="font-size: 18px;"><strong><?php echo e($monitoring->code); ?></strong></span></p>
                        </div>
                    </div>
                    <div style="color:#FFD7CB;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:150%;padding-top:0px;padding-right:10px;padding-bottom:5px;padding-left:10px;">
                        <div style="font-size: 12px; line-height: 18px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #FFD7CB;">
                        ...
                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                            <div style="color:#555555;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                <div style="font-size: 12px; line-height: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555;">
                                    <p style="font-size: 14px; line-height: 14px; text-align: left; margin: 0;"><span style="font-size: 12px;">Organo Electoral Plurinacional | <?php echo e(date('d/m/Y H:i')); ?>  </span> <span class="number_page"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <?php if($monitoring->registered_media): ?>
                        <span><?php echo e($monitoring->mediaProfile->name); ?> - <?php echo e($monitoring->mediaProfile->business_name); ?></span>
                    <?php else: ?>
                        <span><?php echo e($monitoring->other_media); ?> </span>
                    <?php endif; ?>
                </td>
            </tr>
        </table>
                ...
                <?php if(is_array($fields) && count($fields) > 0): ?>
                    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php switch($field->fieldType->type):
                            ...
                            <?php case ('textarea'): ?>
                                <tr>
                                    <td><b><?php echo e($field->label); ?>:</b></td>
                                    <td><?php echo e($input[$field->unique_fieldname] ? $input[$field->unique_fieldname] : ''); ?></td>
                                </tr>
                            <?php break; ?>
                                        ...
                                        <?php if($field->options_type === 'custom'): ?>
                                            ...
                                            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($option->value, $selecteds)): ?>
                                                    <span><?php echo e($option->text); ?></span><br>
                                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(isset($input[$field->unique_fieldname]) && is_array($input[$field->unique_fieldname])): ?>
                                            <span><?php echo e($input[$field->unique_fieldname]['url_file']); ?></span>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php break; ?>
...
<?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\resources\views/pdf/monitoringPDF.blade.php ENDPATH**/ ?>