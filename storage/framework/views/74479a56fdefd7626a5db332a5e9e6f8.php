<div>
    ...
    <?php if($profile_data->media_type_television): ?>
        <?php
    ...
    <?php if($profile_data->media_type_radio): ?>
        <?php
    ...
    <?php if($profile_data->media_type_print): ?>
        <?php
    ...
    <?php if($profile_data->media_type_digital): ?>
        <?php
