    ...
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            ...
            <div class="card-body pt-0">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_media_profiles" data-url="<?php echo e(route('oep_admin_media_profiles_json_dt_new')); ?>">
                    <thead>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', ['page' => 'media_list_news'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\OepAdministrator/UI/WEB/Views//mediaProfile/listNew.blade.php ENDPATH**/ ?>