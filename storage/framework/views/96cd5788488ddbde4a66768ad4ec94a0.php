...
<?php $__env->startSection('content'); ?>
    <div id="kt_app_content" class="app-content">
        ...
        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10" id="kt_create_accreditation_stepper">
            ...
            <!--begin::Content-->
                <form class="card-body_xx py-20_xx w-100 mw-xl-700px_xx px-9_xx" action="<?php echo e(route('ext_admin_accreditations_update', ['id' => $accreditation->id])); ?>" novalidate="novalidate" id="kt_election_accreditation_form" method="post">
                    <!--begin::Step 1-->
                        ...
                        <div class="card d-flex flex-row-fluid flex-center mb-10">
                            ...
                            <div class="fv-row mb-10">
                                <?php if($accreditation->filePricingList): ?>
                                    <input type="hidden" name="file_pricing_list" data-name="<?php echo e($accreditation->filePricingList->origin_name); ?>" data-size="<?php echo e($accreditation->filePricingList->size); ?>"
