...
<?php $__env->startSection('breadcrumbs'); ?>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <li class="breadcrumb-item text-white fw-bold lh-1">Lista de acreditaciones</li>
    </ul>
    ...
    <div id="kt_app_content" class="app-content">
        ...
        <div class="d-flex flex-wrap flex-stack pb-7">
            ...
            <div class="d-flex flex-wrap my-1">
                <a href="<?php echo e(route('ext_admin_accreditations_new')); ?>" class="btn btn-primary"><i class="ki-outline ki-file-added fs-3 me-1"></i>Nueva Acreditación</a>
            </div>
        </div>

        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_accreditations" data-url="<?php echo e(route('ext_admin_accreditations_list_json_dt')); ?>">
                    <thead>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/external/js/custom/accreditation/list.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::external.layouts.master', ['page' => 'media_accreditations'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\ExtAdministrator/UI/WEB/Views//accreditation/listAccreditations.blade.php ENDPATH**/ ?>