...
<?php $__env->startSection('breadcrumbs'); ?>
    <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
        <h1 class="d-flex text-gray-900 fw-bold m-0 fs-3">NUEVOS REGISTROS</h1>
            ...
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_media_profiles" data-url="<?php echo e(route('oep_admin_media_profiles_json_dt')); ?>">
                    ...
                    <tr>
                        ...
                        <td class="pe-0">carlos@mail.com</td>
                        <td class="pe-0">
                            Generales, Primarias
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/admin/js/custom/media_profiles/list_new.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\CoreMonitoring\UserProfile/UI/WEB/Views//listNew.blade.php ENDPATH**/ ?>