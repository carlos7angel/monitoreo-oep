                    ...
                    <div class="m-0">
                        ...
                        <div>
                            <?php if(auth()->user()->hasRole('analyst')): ?>
                                <?php switch($analysis_report->status):
                                    case ('NEW'): ?>
                                    <div class="mb-5">
                            ...
                            <?php if(auth()->user()->hasRole('secretariat')): ?>
                                <?php switch($analysis_report->status):
                                    case ('UNTREATED'): ?>
                                    <div class="mb-5">
                                        ...
                                        data-url="<?php echo e(route('oep_admin_analysis_report_in_treatment', ['id' => $analysis_report->id])); ?>">
                                            <i class="ki-outline ki-notepad-edit fs-3 me-1"></i>Iniciar Tratamiento
                                        </button>
                                    </div>
                                    <?php break; ?>
                                    <?php case ('IN_TREATMENT'): ?>
                                    <div class="mb-5">
                            ...
                            <?php if(auth()->user()->hasRole('plenary')): ?>
                                <?php switch($analysis_report->status):
                                    ...
                                    <?php break; ?>
                                    <?php case ('COMPLEMENTARY_REPORT_PLENARY'): ?>
                                    <div class="mb-5">
                                        <button type="button" class="kt_change_analysis_report_status_final_resolution btn btn-primary w-100 mb-0 fs-8">
                                            <i class="ki-outline ki-file-added fs-3 me-1"></i>Resolución Final
                                        </button>
                        ...
                        <div class="d-print-none border border-dashed border-primary__ border-gray-300 card-rounded h-lg-100__ min-w-md-350px p-9 bg-lighten mb-20">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="fw-bold text-gray-800 fs-6"><?php echo e($analysis_report->code); ?></div>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="fw-bold text-gray-800 fs-6"><?php echo e($analysis_report->lastStatusActivity->registered_at); ?></div>
                            </div>
                            <div class="mb-15">
                                <div class="fw-semibold text-gray-600 fs-7">Registrado por:</div>
                                <div class="fw-bold text-gray-800 fs-6"><?php echo e($analysis_report->lastStatusActivity->user->name); ?></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-n1">
                            <div class="d-flex d-flex justify-content-between flex-stack__ pb-10__">
                                ...
                                <div class="text-sm-end fw-semibold fs-7 text-muted">
                                    <img alt="Logo Proceso Electoral" src="<?php echo e(asset('storage') . $analysis_report->election->logo_image); ?>" class="h-100px mb-2" />
                            ...
                            <div class="m-0">
                                ...
                                <div class="pb-5 wrapper_content_files_ro">
                                    ...
                                    <?php if($analysis_report->fileAnalysisReport): ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="hdn_analysis_file_report" class="file_default"
                                                   data-name="<?php echo e($analysis_report->fileAnalysisReport->origin_name); ?>" data-size="<?php echo e($analysis_report->fileAnalysisReport->size); ?>"
                                                   data-mimetype="<?php echo e($analysis_report->fileAnalysisReport->mime_type); ?>" data-path="<?php echo e($analysis_report->fileAnalysisReport->url_file); ?>">
                                    ...
                                    <?php if($analysis_report->fileAnalysisComplementaryReport): ?>
                                    <div class="row">
                                        <div class="col-md-4 d-flex align-items-center justify-content-end text-end">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="hdn_analysis_file_complementary_report" class="file_default"
                                                   data-name="<?php echo e($analysis_report->fileAnalysisComplementaryReport->origin_name); ?>" data-size="<?php echo e($analysis_report->fileAnalysisComplementaryReport->size); ?>"
                                                   data-mimetype="<?php echo e($analysis_report->fileAnalysisComplementaryReport->mime_type); ?>" data-path="<?php echo e($analysis_report->fileAnalysisComplementaryReport->url_file); ?>">
                                    ...
                                    <?php if($analysis_report->fileAnalysisComplementaryReportPlenary): ?>
                                    <div class="row">
                                        <div class="col-md-4 d-flex align-items-center justify-content-end text-end">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="hdn_analysis_file_complementary_report" class="file_default"
                                                   data-name="<?php echo e($analysis_report->fileAnalysisComplementaryReportPlenary->origin_name); ?>" data-size="<?php echo e($analysis_report->fileAnalysisComplementaryReportPlenary->size); ?>"
                                                   data-mimetype="<?php echo e($analysis_report->fileAnalysisComplementaryReportPlenary->mime_type); ?>" data-path="<?php echo e($analysis_report->fileAnalysisComplementaryReportPlenary->url_file); ?>">
                                    ...
                                    <?php if($analysis_report->fileAnalysisResolutionFirstInstance): ?>
                                    <div class="row">
                                        <div class="col-md-4 d-flex align-items-center justify-content-end text-end">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="hdn_analysis_file_complementary_report" class="file_default"
                                                   data-name="<?php echo e($analysis_report->fileAnalysisResolutionFirstInstance->origin_name); ?>" data-size="<?php echo e($analysis_report->fileAnalysisResolutionFirstInstance->size); ?>"
                                                   data-mimetype="<?php echo e($analysis_report->fileAnalysisResolutionFirstInstance->mime_type); ?>" data-path="<?php echo e($analysis_report->fileAnalysisResolutionFirstInstance->url_file); ?>">
                                    ...
                                    <?php if($analysis_report->fileAnalysisResolutionFinalInstance): ?>
                                    <div class="row">
                                        <div class="col-md-4 d-flex align-items-center justify-content-end text-end">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="hdn_analysis_file_complementary_report" class="file_default"
                                                   data-name="<?php echo e($analysis_report->fileAnalysisResolutionFinalInstance->origin_name); ?>" data-size="<?php echo e($analysis_report->fileAnalysisResolutionFinalInstance->size); ?>"
                                                   data-mimetype="<?php echo e($analysis_report->fileAnalysisResolutionFinalInstance->mime_type); ?>" data-path="<?php echo e($analysis_report->fileAnalysisResolutionFinalInstance->url_file); ?>">
                                ...
                                <div class="d-flex flex-aligns-center mb-5">
                                    <img alt="" class="w-30px me-3" src="<?php echo e(asset('themes/common/media/svg/files/pdf.svg')); ?>">
                                    <div class="ms-1 fw-semibold">
                                        <a href="<?php echo e(route('oep_admin_media_monitoring_generate_pdf', ['id' => $analysis_report->monitoringReport->monitoringItem->id])); ?>" target="_blank" class="fs-6 text-hover-primary__ fw-bold">Descargar</a>
                                    </div>
                                </div>
                        ...
                        <div class="timeline-label">
                            ...
                            <div class="timeline-item">
                                <div class="timeline-label fw-bold text-gray-800 fs-6 min-w-175px">
                                    <?php echo e($activity->registered_at); ?>
                                ...
                                <div class="fw-semibold text-gray-700 ps-3 fs-7">
                                    <span class="text-primary"><?php echo e($activity->user->name); ?></span>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content rounded" id="kt_block_target_rejected">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="kt_form_analysis_report_rejected" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_analysis_report_reject', ['id' => $analysis_report->id])); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded" id="kt_block_target_to_secretariat">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7 pt-0 pb-15">
                    ...
                    <form id="kt_form_analysis_report_submit_to_secretariat" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_analysis_report_to_secretariat', ['id' => $analysis_report->id])); ?>">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <?php if($analysis_report->scope_type === 'TED'): ?>
                                <input type="text" class="form-control form-control-solid" name="analysis_scope" value=" TED <?php echo e($analysis_report->scope_department); ?>" readonly />
                            <?php else: ?>
                            <select class="form-select" data-control="select2" data-hide-search="true" data-placeholder="" name="analysis_scope">
                                <option value="Nacional" <?php echo e($analysis_report->scope_department == 'Nacional' ? 'selected="selected"' : ''); ?>>TSE Nacional</option>
                                <option value="La Paz" <?php echo e($analysis_report->scope_department == 'La Paz' ? 'selected="selected"' : ''); ?>>TED La Paz</option>
                                <option value="Oruro" <?php echo e($analysis_report->scope_department == 'Oruro' ? 'selected="selected"' : ''); ?>>TED Oruro</option>
                                <option value="Potosí" <?php echo e($analysis_report->scope_department == 'Potosí' ? 'selected="selected"' : ''); ?>>TED Potosí</option>
                                <option value="Pando" <?php echo e($analysis_report->scope_department == 'Pando' ? 'selected="selected"' : ''); ?>>TED Pando</option>
                                <option value="Beni" <?php echo e($analysis_report->scope_department == 'Beni' ? 'selected="selected"' : ''); ?>>TED Beni</option>
                                <option value="Santa Cruz" <?php echo e($analysis_report->scope_department == 'Santa Cruz' ? 'selected="selected"' : ''); ?>>TED Santa Cruz</option>
                                <option value="Cochabamba" <?php echo e($analysis_report->scope_department == 'Cochabamba' ? 'selected="selected"' : ''); ?>>TED Cochabamba</option>
                                <option value="Chuquisaca" <?php echo e($analysis_report->scope_department == 'Chuquisaca' ? 'selected="selected"' : ''); ?>>TED Chuquisaca</option>
                                <option value="Tarija" <?php echo e($analysis_report->scope_department == 'Tarija' ? 'selected="selected"' : ''); ?>>TED Tarija</option>
                            </select>
                            <?php endif; ?>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded" id="kt_block_target_complementary">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7 pt-0 pb-15">
                    ...
                    <form id="kt_form_analysis_report_complementary" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_analysis_report_complementary', ['id' => $analysis_report->id])); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded" id="kt_block_target_first_resolution">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7 pt-0 pb-15">
                    ...
                    <form id="kt_form_analysis_report_first_resolution" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_analysis_report_first_resolution', ['id' => $analysis_report->id])); ?>">
                        <div class="fv-row mb-10">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded" id="kt_block_target_final_resolution">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7 pt-0 pb-15">
                    ...
                    <form id="kt_form_analysis_report_final_resolution" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_analysis_report_final_resolution', ['id' => $analysis_report->id])); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/admin/js/custom/analysis_report/detail.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', ['page' => 'analysis_report_list'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\OepAdministrator/UI/WEB/Views//analysisReport/detail.blade.php ENDPATH**/ ?>