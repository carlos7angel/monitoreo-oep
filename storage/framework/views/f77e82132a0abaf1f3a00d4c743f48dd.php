                        ...
                        <div class="mt-n1">
                            <div class="d-flex flex-stack pb-10">
                                ...
                                <div class="text-sm-end fw-semibold fs-7 text-muted">
                                    ...
                                    <div><?php echo e($analysis_report->election->name); ?></div>
                                    <div><?php echo e($analysis_report->election->election_date); ?></div>
                                </div>
                            </div>
                            <div class="m-0">
                                ...
                                <div class="flex-grow-1">
                                    <?php $__currentLoopData = ['TV','RADIO','PRINT','DIGITAL','RRSS']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($analysis_report->monitoringReport->monitoringItems->where('media_type', $media_type)->count() > 0): ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table border align-middle gs-0 gy-4 mb-3">
                                                    ...
                                                    <tbody>
                                                    <?php $__currentLoopData = $analysis_report->monitoringReport->monitoringItems->where('media_type', $media_type); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $monitoring_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="border-bottom fw-bold text-gray-700 fs-7">
                                                            ...
                                                            <td class="text-end">
                                                                <button type="button" class="btn btn-sm btn-icon btn-secondary kt_btn_monitoring_item_show me-2"
                                                                        data-url="<?php echo e(route('oep_admin_monitoring_report_details_item', ['id' => $analysis_report->monitoringReport->id, 'monitoring_item_id' => $monitoring_item->id])); ?>">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="kt_form_update_status_monitoring_status" class="form" method="post" autocomplete="off"
                          action="<?php echo e(route('oep_admin_monitoring_report_change_status', ['id' => $analysis_report->id])); ?>">
