...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <div class="d-flex align-items-center">
        <a href="javascript:void(0)" class="btn btn-sm btn-primary px-5" id="kt_button_new_form"><i class="las la-plus-square fs-2 me-2"></i> Nuevo Formulario</a>
    </div>
        ...
        <div class="card mb-7">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="submit" id="kt_search" class="btn btn-primary me-5">Buscar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="kt_form_new_form" class="form" method="post" autocomplete="off" action="<?php echo e(route('oep_admin_forms_store')); ?>">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="fs-6 fw-semibold mb-2">Json Form Builder</label>
                            <textarea class="form-control" rows="4" name="form_schema_web" placeholder=""></textarea>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\CoreMonitoring\FormBuilder/UI/WEB/Views//list.blade.php ENDPATH**/ ?>