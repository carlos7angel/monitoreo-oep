...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <div class="d-flex align-items-center">
        <a href="<?php echo e(route('oep_admin_political_group_create')); ?>" class="btn btn-primary px-5" id="kt_button_new_form"><i class="ki-outline ki-add-files me-2 fs-3"></i> Nuevo Partido</a>
    </div>
...
<?php $__env->startSection('content'); ?>
    <div class="content flex-row-fluid" id="kt_content">
        ...
        <div class="card card-flush">
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_political_group_profiles" data-url="<?php echo e(route('oep_admin_political_group_list_json_dt')); ?>">
                    <thead>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/admin/js/custom/political_group_profiles/list.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', ['page' => 'political_group_list'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\OepAdministrator/UI/WEB/Views//politicalGroup/list.blade.php ENDPATH**/ ?>