            ...
            <div class="col-xl-8">
                ...
                <div class="card card-flush h-lg-100" style="border: none !important; box-shadow: unset !important;">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <form id="kt_propaganda_material_form_edit" class="form" action="<?php echo e(route('ext_admin_propaganda_material_update', ['registration_id' => $registration->id, 'id' => $material->id])); ?>" method="post" autocomplete="off">

                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold form-label mt-3">
                                    <span class="required">Título</span>
                                </label>
                                <input type="text" class="form-control" name="material_name" value="<?php echo e($material->name); ?>" />
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control" rows="3" name="material_description"><?php echo $material->description; ?></textarea>
                            </div>
                            ...
                            <div class="mb-7 fv-row">
                                ...
                                <div class="d-flex __fv-row">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input me-3" name="material_type" type="radio" value="LINK" id="kt_type_option_0" <?php echo e($material->type == 'LINK' ? 'checked="checked"' : ''); ?> />
                                ...
                                <div class="d-flex __fv-row">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input me-3" name="material_type" type="radio" value="FILE" id="kt_type_option_1" <?php echo e($material->type == 'FILE' ? 'checked="checked"' : ''); ?> />
                            ...
                            <div class="kt_material_wrapper_input_file <?php echo e($material->type == 'FILE' ? 'd-block' : 'd-none'); ?>">
                                <div class="fv-row mb-7">
                                    <?php if($material->fileMaterial): ?>
                                        <input type="hidden" name="default_file_material" data-name="<?php echo e($material->fileMaterial->origin_name); ?>" data-size="<?php echo e($material->fileMaterial->size); ?>"
                                               data-mimetype="<?php echo e($material->fileMaterial->mime_type); ?>" data-path="<?php echo e($material->fileMaterial->url_file); ?>">
                                    <?php endif; ?>
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span>Archivo</span>
                                    </label>
                            ...
                            <div class="kt_material_wrapper_input_link <?php echo e($material->type == 'LINK' ? 'd-block' : 'd-none'); ?>">
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold form-label mt-3">
                                        <span class="required">Enlace al material</span>
                                    </label>
                                    <input type="text" class="form-control" name="material_link" value="<?php echo e($material->link_material); ?>" />
                                </div>
                            </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('themes/external/js/custom/propaganda-material/edit.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::external.layouts.master', ['page' => 'political_group_registrations'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\ExtAdministrator/UI/WEB/Views//propagandaMaterial/editMaterial.blade.php ENDPATH**/ ?>