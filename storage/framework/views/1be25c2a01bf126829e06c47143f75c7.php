                        ...
                        <form id="kt_media_profile_category_data_form" class="form" action="<?php echo e(route('ext_admin_media_profile_category_data_store')); ?>" method="post" autocomplete="off">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="media_type[]" value="Televisivo" <?php echo e(in_array('Televisivo', $types) ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Televisión</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="media_type[]" value="Radial" <?php echo e(in_array('Radial', $types) ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Radio</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="media_type[]" value="Impreso" <?php echo e(in_array('Impreso', $types) ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Impreso</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="media_type[]" value="Digital" <?php echo e(in_array('Digital', $types) ? 'checked="checked"' : ''); ?> />
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Seleccione una opción"
                                                ...
                                                <option></option>
                                                <option value="Nacional" <?php echo e($profile->coverage == 'Nacional' ? 'selected="selected"' : ''); ?>>Nacional</option>
                                                <option value="La Paz" <?php echo e($profile->coverage == 'La Paz' ? 'selected="selected"' : ''); ?>>La Paz</option>
                                                <option value="Cochabamba" <?php echo e($profile->coverage == 'Cochabamba' ? 'selected="selected"' : ''); ?>>Cochabamba</option>
                                                <option value="Santa Cruz" <?php echo e($profile->coverage == 'Santa Cruz' ? 'selected="selected"' : ''); ?>>Santa Cruz</option>
                                                <option value="Chuquisaca" <?php echo e($profile->coverage == 'Chuquisaca' ? 'selected="selected"' : ''); ?>>Chuquisaca</option>
                                                <option value="Tarija" <?php echo e($profile->coverage == 'Tarija' ? 'selected="selected"' : ''); ?>>Tarija</option>
                                                <option value="Oruro" <?php echo e($profile->coverage == 'Oruro' ? 'selected="selected"' : ''); ?>>Oruro</option>
                                                <option value="Potosí" <?php echo e($profile->coverage == 'Potosí' ? 'selected="selected"' : ''); ?>>Potosí</option>
                                                <option value="Beni" <?php echo e($profile->coverage == 'Beni' ? 'selected="selected"' : ''); ?>>Beni</option>
                                                <option value="Pando" <?php echo e($profile->coverage == 'Pando' ? 'selected="selected"' : ''); ?>>Pando</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Seleccione una opción"
                                                ...
                                                <option></option>
                                                <option value="Nacional" <?php echo e($profile->scope == 'Nacional' ? 'selected="selected"' : ''); ?>>Nacional</option>
                                                <option value="Departamental" <?php echo e($profile->scope == 'Departamental' ? 'selected="selected"' : ''); ?>>Departamental</option>
                                                <option value="Municipal" <?php echo e($profile->scope == 'Municipal' ? 'selected="selected"' : ''); ?>>Municipal</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Selecciona los departamentos" data-allow-clear="true" multiple="multiple"
                                                ...
                                                <option></option>
                                                <option value="La Paz" <?php echo e(in_array('La Paz', $states) ? 'selected="selected"' : ''); ?>>La Paz</option>
                                                <option value="Cochabamba" <?php echo e(in_array('Cochabamba', $states) ? 'selected="selected"' : ''); ?>>Cochabamba</option>
                                                <option value="Santa Cruz" <?php echo e(in_array('Santa Cruz', $states) ? 'selected="selected"' : ''); ?>>Santa Cruz</option>
                                                <option value="Chuquisaca" <?php echo e(in_array('Chuquisaca', $states) ? 'selected="selected"' : ''); ?>>Chuquisaca</option>
                                                <option value="Tarija" <?php echo e(in_array('Tarija', $states) ? 'selected="selected"' : ''); ?>>Tarija</option>
                                                <option value="Oruro" <?php echo e(in_array('Oruro', $states) ? 'selected="selected"' : ''); ?>>Oruro</option>
                                                <option value="Potosi" <?php echo e(in_array('Potosi', $states) ? 'selected="selected"' : ''); ?>>Potosi</option>
                                                <option value="Beni" <?php echo e(in_array('Beni', $states) ? 'selected="selected"' : ''); ?>>Beni</option>
                                                <option value="Pando" <?php echo e(in_array('Pando', $states) ? 'selected="selected"' : ''); ?>>Pando</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Selecciona un departamento"
                                                ...
                                                <option></option>
                                                <option value="La Paz" <?php echo e($state == 'La Paz' ? 'selected="selected"' : ''); ?>>La Paz</option>
                                                <option value="Cochabamba" <?php echo e($state == 'Cochabamba' ? 'selected="selected"' : ''); ?>>Cochabamba</option>
                                                <option value="Santa Cruz" <?php echo e($state == 'Santa Cruz' ? 'selected="selected"' : ''); ?>>Santa Cruz</option>
                                                <option value="Chuquisaca" <?php echo e($state == 'Chuquisaca' ? 'selected="selected"' : ''); ?>>Chuquisaca</option>
                                                <option value="Tarija" <?php echo e($state == 'Tarija' ? 'selected="selected"' : ''); ?>>Tarija</option>
                                                <option value="Oruro" <?php echo e($state == 'Oruro' ? 'selected="selected"' : ''); ?>>Oruro</option>
                                                <option value="Potosí" <?php echo e($state == 'Potosí' ? 'selected="selected"' : ''); ?>>Potosí</option>
                                                <option value="Beni" <?php echo e($state == 'Beni' ? 'selected="selected"' : ''); ?>>Beni</option>
                                                <option value="Pando" <?php echo e($state == 'Pando' ? 'selected="selected"' : ''); ?>>Pando</option>
                                            </select>
                                        </div>
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        ?>
                                        <input type="text" class="form-control" name="media_scope_municipality" value="<?php echo e($municipality); ?>" />
