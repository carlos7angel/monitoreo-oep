...
<?php $__env->startSection('breadcrumbs'); ?>
    <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
        ...
        <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
            ...
            <li class="breadcrumb-item text-gray-600">Elecciones</li>
            <li class="breadcrumb-item text-gray-500">Listado</li>
        </ul>
    </div>
    <div class="d-flex align-items-center">
        <a href="<?php echo e(route('oep_admin_elections_create')); ?>" class="btn btn-primary px-5" id="kt_button_new_form"><i class="las la-plus fs-2 me-2"></i> Nuevo Proceso Electoral</a>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="position-relative w-md-400px me-md-2">
                        ...
                        <input type="text" class="form-control form-control-solid ps-10" name="dt_search_input" value="" placeholder="Buscador" />
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <a href="javascript:void(0)" id="kt_advanced_search" class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#kt_advanced_search_form">Búsqueda avanzada</a>
                    </div>
                </div>
                    ...
                    <div class="row g-8 mb-8">
                        ...
                        <div class="col-xxl-5">
                            ...
                            <select class="form-select form-select-solid datatable-input" data-col-index="3" name="kt_search_type" data-control="select2" data-placeholder="Seleccionar" data-hide-search="true">
                                ...
                                <option value="Referendos">Elecciones Referendos</option>
                            </select>
                        </div>
                    </div>
                    <div class="row g-8">
                        ...
                        <div class="col-xxl-4">
                            ...
                            <input type="text" class="form-control form-control form-control-solid datatable-input" data-col-index="4" name="kt_search_date" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_elections" data-url="<?php echo e(route('oep_admin_elections_json_dt')); ?>">
                    ...
                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-70px">Identificador</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\CoreMonitoring\Election/UI/WEB/Views//list.blade.php ENDPATH**/ ?>