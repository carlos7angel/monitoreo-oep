                        ...
                        <div class="d-flex flex-column flex-lg-row  gx-9_ h-100">
                            <div class="flex-column flex-lg-row-auto w-lg-300px w-xl-300px me-lg-15">
                                <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-w-300px h-100">
                                    <img src="<?php echo e(asset('storage') . $election->logo_image); ?>" class="w-100" style="max-height: 200px" alt="Logo Proceso Electoral">
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-7">
                                        <div class="d-flex flex-stack mb-6">
                                            <div class="flex-shrink-0 me-5">
                                                ...
                                                <span class="text-gray-800 fs-2 fw-bold"><?php echo e($election->name); ?></span>
                                            </div>
                                    ...
                                    <div class="mb-6">
                                        <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">
                                            <?php echo e(substr($election->description, 0, 200) . "..."); ?>
                ...
                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #F1416C;background-image:url('assets/media/svg/shapes/wave-bg-red.svg')">
                    ...
                    <div class="card-body d-flex align-items-end mb-3">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <span class="fs-2hx text-white fw-bold me-6"><?php echo e($count_users_media); ?></span>
                        ...
                        <div class="d-flex align-items-center">
                            <span class="fs-2hx text-white fw-bold me-6"><?php echo e($count_users_political); ?></span>
                            <div class="fw-bold fs-6 text-gray-400">
                                <span class="d-block">Cuentas de</span>
        ...
        <div class="row g-5 g-xl-10 mb-xl-10">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                        <div class="fs-2tx fw-bold mb-3"><?php echo e($count_accreditations); ?></div>
                        <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                            <i class="ki-duotone ki-Up-right fs-3 me-1 text-danger"></i>
                            <div class="fw-semibold text-gray-500">Medios acreditados</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                        <div class="fs-2tx fw-bold mb-3"><?php echo e($count_registrations); ?></div>
                        <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                            <i class="ki-duotone ki-Up-right fs-3 me-1 text-danger"></i>
                            <div class="fw-semibold text-gray-500">Partidos Políticos</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                        <div class="fs-2tx fw-bold mb-3"><?php echo e($count_monitoring); ?></div>
                        <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                            <i class="ki-duotone ki-Up-right fs-3 me-1 text-danger"></i>
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                        <div class="fs-2tx fw-bold mb-3"><?php echo e($count_analysis); ?></div>
                        <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                            <i class="ki-duotone ki-Up-right fs-3 me-1 text-danger"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vendor@template::admin.layouts.master', ['page' => 'dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Development Environment\PHP Environment\Laragon\www\monitoreo-oep\app\Containers\Frontend\OepAdministrator/UI/WEB/Views//index.blade.php ENDPATH**/ ?>