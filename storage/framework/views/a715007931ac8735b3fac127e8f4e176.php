                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3 fv-row"  data-kt-image-input="true">
                            ...
                            ?>
                            <div class="image-input-wrapper w-200px h-200px bgi-size-contain bgi-position-center <?php echo e($file_logo ? 'bg-white' : ''); ?>" style="background-image: url(<?php echo e($file_logo); ?>)"></div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3 fv-row"  data-kt-image-input="true">
                            ...
                            ?>
                            <div class="image-input-wrapper w-200px h-200px bgi-size-contain bgi-position-center <?php echo e($file_banner ? 'bg-white' : ''); ?>" style="background-image: url(<?php echo e($file_banner); ?>)"></div>
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Cambiar">
                                <i class="ki-duotone ki-pencil fs-7"><span class="path1"></span><span class="path2"></span></i>
