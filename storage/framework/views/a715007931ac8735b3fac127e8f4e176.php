                        ...
                        <div id="kt_wrapper_enable_monitoring">
                            <div class="fv-row mb-10">
                                ...
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="election_monitoring_media_television" value="1" <?php echo e($election->enable_monitoring_television_media ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Medios Televisivos</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="election_monitoring_media_radio" value="1" <?php echo e($election->enable_monitoring_radio_media ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Medios Radiales</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="election_monitoring_media_print" value="1" <?php echo e($election->enable_monitoring_print_media ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Medios Impresos</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="election_monitoring_media_digital" value="1" <?php echo e($election->enable_monitoring_digital_media ? 'checked="checked"' : ''); ?> />
                                    <label class="form-check-label fw-semibold">Medios Digitales</label>
                                </div>
                                <div class="form-check form-check-custom mb-3">
                                    <input class="form-check-input h-25px w-25px" type="checkbox" name="election_monitoring_media_social" value="1" <?php echo e($election->enable_monitoring_social_media ? 'checked="checked"' : ''); ?> />
