                ...
                <div class="align-self-end overflow-auto" id="kt_brand_tabs">
                    <div class="header-tabs overflow-auto mx-4 ms-lg-10 mb-5 mb-lg-0" id="kt_header_tabs" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_header_navs_wrapper', lg: '#kt_brand_tabs'}">
                        <ul class="nav flex-nowrap text-nowrap">
                            ...
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'media|admin|super')): ?>
                            <li class="nav-item">
                            ...
                            <?php endif; ?>
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'monitor|analyst|secretariat|plenary|admin|super')): ?>
                            <li class="nav-item">
                            ...
                            <?php endif; ?>
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'admin|super')): ?>
                            <li class="nav-item">
                            ...
                            <?php endif; ?>
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'super')): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(in_array($page, ['form_list', 'user_list', 'log_list']) ? 'active' : ''); ?>" data-bs-toggle="tab" href="#kt_header_navs_tab_6">Preferencias</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5">
                            <a href="<?php echo e(route('oep_admin_my_profile')); ?>" class="menu-link px-5">Mi Perfil</a>
                        </div>
                        <div class="separator my-2"></div>
                        <div class="menu-item px-5">
            ...
            <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
                <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}" data-kt-scroll-height="auto" data-kt-scroll-offset="70px">
                    ...
                    <div class="tab-pane fade <?php echo e(in_array($page, ['monitoring_list', 'monitoring_report_list', 'analysis_report_list']) ? 'active show' : ''); ?>" id="kt_header_navs_tab_3">
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'monitor|admin|super')): ?>
                                ...
                                <?php endif; ?>
                                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'analyst|admin|super')): ?>
                                ...
                                <?php endif; ?>
                                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'analyst|secretariat|plenary|admin|super')): ?>
                    ...
                    <?php endif; ?>
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'admin|super')): ?>
                    <div class="tab-pane fade <?php echo e(in_array($page, ['election_list', 'election_create']) ? 'active show' : ''); ?>" id="kt_header_navs_tab_4">
                        <!--begin::Menu wrapper-->
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                    ...
                    <?php endif; ?>
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'admin|super')): ?>
                    <div class="tab-pane fade <?php echo e(in_array($page, ['political_group_list', 'political_group_create']) ? 'active show' : ''); ?>" id="kt_header_navs_tab_5">
                        <!--begin::Menu wrapper-->
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <a href="<?php echo e(route('oep_admin_political_group_create')); ?>" class="menu-item <?php echo e($page === 'political_group_create' ? 'here' : ''); ?> me-0 me-lg-2">
                                    <span class="menu-link py-3">
                    ...
                    <?php endif; ?>
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', 'super')): ?>
                    <div class="tab-pane fade <?php echo e(in_array($page, ['form_list', 'user_list', 'log_list']) ? 'active show' : ''); ?>" id="kt_header_navs_tab_6">
                        <!--begin::Menu wrapper-->
                        <div class="header-menu flex-column align-items-stretch flex-lg-row">
                            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                                ...
                                <a href="<?php echo e(route('oep_admin_activity_logs')); ?>" class="menu-item <?php echo e($page === 'log_list' ? 'here' : ''); ?> me-0 me-lg-2">
                                    <span class="menu-link py-3">
