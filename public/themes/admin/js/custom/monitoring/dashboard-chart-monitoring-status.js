...
var KTAnalysisChart = function () {
    ...
    var _initAnalysisChart = function () {
        ...
        element = document.getElementById("kt_chart_analysis_by_status");
        if (!element) { return; }
    ...
    var loadData = function(election_id) {
        var url = '/admin/monitoreo/dashboard/json/analisis-estado/' + election_id;
