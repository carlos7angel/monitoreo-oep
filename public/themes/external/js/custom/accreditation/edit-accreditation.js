...
var KTAccreditationElection = function () {
    ...
    var _initFilesReadOnly = function () {
        ...
        var default_request_letter = extractFileData('input[name="file_ro_request_letter"]');
        _initFileUploaderNoInput('#kt_media_file_ro_request_letter', default_request_letter);

        var default_affidavit = extractFileData('input[name="file_ro_affidavit"]');
        _initFileUploaderNoInput('#kt_media_file_ro_affidavit', default_affidavit);

        var default_pricing_list = extractFileData('input[name="file_ro_pricing_list"]');
        _initFileUploaderNoInput('#kt_media_file_ro_pricing_list', default_pricing_list);
